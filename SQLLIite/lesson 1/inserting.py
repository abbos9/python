...
product3 = (3, 'rug', 10,
            ...
            20)
product4 = (4, 'mouse ', 800,
            'https://i.rtings.com/assets/products/1htouLNw/amazonbasics-3-button-usb-wired-mouse/design-medium.jpg',
            20)
product5 = (5, 'keyboard', 100, 'https://www.computerhope.com/cdn/keyboard/keyboard.jpg',
            20)

product6 = (6, "jacket", 30,
